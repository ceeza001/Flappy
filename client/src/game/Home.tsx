					...
					{!gameOver ? (
						...
						<div className="h-[100dvh] w-full text-white bg-black bg-grid-white/[0.2] relative flex items-start">
							...
							<div className="absolute bottom-0 w-full p-2 flex gap-4 justify-between items-center">
								<button onClick={gameToggle} className="flex items-center justify-center gap-2 w-full bg-[#121417] border-2 border-[#1F1F22] text-white rounded-lg py-4 px-2 cursor-pointer">
								  <><img 
								...
								<button onClick={() => setGameOver(false)} className="flex items-center justify-center gap-2 w-full bg-green-500 text-white rounded-lg px-2 py-4 cursor-pointer hover:bg-blue-700">
								  <><img 
				...
				<main className="h-[100dvh] w-full text-white bg-black bg-dot-white/[0.2] relative">
					...
					<footer className="absolute bottom-0 left-0 right flex justify-between items-center gap-2 p-[1rem] w-full">
						...
						<motion.div
							...
							>
							<button onClick={gameToggle} className="flex items-center gap-2 w-full bg-green-500 text-white rounded-lg px-2 py-4 cursor-pointer hover:bg-blue-700">
								<img 
									src="/assets/UI/play.svg"
									alt="play"
									className="w-4 h-4"
